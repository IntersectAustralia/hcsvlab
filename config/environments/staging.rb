HcsvlabWeb::Application.configure do
  ...
  GA.tracker = "UA-49040235-4"

  # TODO: set your own correct URL for action mailer
  config.action_mailer.default_url_options = { :host => 'ic2-hcsvlab-staging1-vm.intersect.org.au' }
  
  config.galaxy_url = 'http://ic2-hcsvlab-staging1-vm.intersect.org.au:8081/root'
