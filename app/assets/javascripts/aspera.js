...
function performAsperaDownloadTransferForItemList(id, doc_filter) {
    ...
    function requestTransferSpec(directory) {
        ...
        $.post('/item_lists/' + id + '/aspera_transfer_spec?doc_filter=' + doc_filter, {}, undefined, 'json').done(function(data) {
