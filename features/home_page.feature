Feature: Home page
  ...
  Scenario: Text is shown when not logged in
    ...
    Then I should see "The University of Western Sydney is proud to be in partnership, and acknowledge funding from, the National eResearch Collaboration Tools and Resources (NeCTAR) project http://www.nectar.org.au to develop the Alveo."
