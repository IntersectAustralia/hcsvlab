Feature: Reject access requests
  ...
  Scenario: Reject an access request from the list page
    ...
    And "diego@intersect.org.au" should receive an email with subject "HCSVLAB - Your access request has been rejected"
    When I open the email
    Then I should see "You made a request for access to the HCSVLAB System. Your request has been rejected. Please contact the HCSVLAB team for further information." in the email body
  ...
  Scenario: Reject an access request as spam from the list page
    ...
    Then they should see "You made a request for access to the HCSVLAB System. Your request has been rejected. Please contact the HCSVLAB team for further information." in the email body
